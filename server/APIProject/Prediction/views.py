...
model = joblib.load(
    "D://final year project/datasets/another dataset/bangalore_home_prices_model.pickle"
)
Col_Name = (
    "total_sqft",
    "bath",
...
def signup(request):
    if request.method == "GET":
        ...
        context[
            "message"
        ] = "Welcome to User signup page, please pass the required fields"
        context[
            "required"
        ] = "username, first_name, last_name, password, password_2, email"
        return Response(context, status=status.HTTP_200_OK)
    ...
    if request.method == "POST":
        ...
        if serializer.is_valid():
            ...
            context[
                "response"
            ] = "User created successfully, you can now login with your username and password"
